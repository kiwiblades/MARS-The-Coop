...
class AppColors {
  ...
  static const Color darkBrown = Color(0xFF6F4E37);      
  static const Color mediumBrown = Color(0xFF634631);    
  
  // functional colors
  static const Color border = Color.fromARGB(255, 71, 50, 35);         // dark brown
  static const Color textPrimary = Color(0xFF3A302D);    // darkest brown (almost black)
  static const Color textSecondary = Color(0xFF634631);  // medium brown
